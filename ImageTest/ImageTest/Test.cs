...
namespace ImageTest1 {
    ...
    class ScanEffectHandler {
        ...
        public async Task<bool> ChangePicture(Image image) {
            ...
            //LockBitmap origanLockBitmap = new LockBitmap(origanBitmap);
            //LockBitmap newLockBitmap = new LockBitmap(newBitmap);
            ...
            for (int y = 0; y < origanBitmap.Height; y++) {
                ...
                //origanLockBitmap.LockBits();
                //newLockBitmap.LockBits();
                //Parallel.For(0, origanBitmap.Width, (x) => {

                //    origanLockBitmap.SetPixel(x, y, newLockBitmap.GetPixel(x, y));
                //});
                //origanLockBitmap.UnlockBits();
